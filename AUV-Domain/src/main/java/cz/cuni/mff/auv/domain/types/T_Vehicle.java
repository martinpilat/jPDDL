...
public class T_Vehicle extends T_Object {
	...
	public static int getPos(T_Vehicle instance) {
		return instance.pos;
	}
	
	public static long getFlag(T_Vehicle instance) {
		return instance.flag;
	}
	
	public static int getIndex(T_Vehicle instance) {
