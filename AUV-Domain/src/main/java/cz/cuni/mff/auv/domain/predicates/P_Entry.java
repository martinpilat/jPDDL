...
import cz.cuni.mff.auv.domain.predicates.P_DupFree.Map_T_Location_1;
 ...
 */
public final class P_Entry extends PDDLPredicate {
	...
	public static final class Storage_P_Entry implements IStorage<P_Entry> {
		...
		@Override
		public void set(P_Entry p) {
			set(p.s, p.l);
		}

		@Override
		public void clear(P_Entry p) {
			clear(p.s, p.l);
		}
