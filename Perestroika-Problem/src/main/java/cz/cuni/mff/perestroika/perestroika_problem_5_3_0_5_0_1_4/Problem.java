...
public final class Problem extends PerestroikaProblem {
	...
	public Problem() {
		...
		state.p_AtRes.set(E_Resources.r10, E_Locations.l_4_1);
		state.p_AtRes.set(E_Resources.r5, E_Locations.l_2_4);
		state.p_AtRes.set(E_Resources.r4, E_Locations.l_2_3);
		state.p_AtRes.set(E_Resources.r7, E_Locations.l_3_1);
		state.p_AtRes.set(E_Resources.r2, E_Locations.l_1_4);
		state.p_AtRes.set(E_Resources.r9, E_Locations.l_3_4);
		state.p_AtRes.set(E_Resources.r8, E_Locations.l_3_2);
		state.p_AtRes.set(E_Resources.r3, E_Locations.l_1_5);
		state.p_AtRes.set(E_Resources.r14, E_Locations.l_4_5);
		state.p_AtRes.set(E_Resources.r15, E_Locations.l_5_3);
		state.p_AtRes.set(E_Resources.r13, E_Locations.l_4_4);
		state.p_AtRes.set(E_Resources.r11, E_Locations.l_4_2);
		state.p_AtRes.set(E_Resources.r1, E_Locations.l_1_3);
		state.p_AtRes.set(E_Resources.r17, E_Locations.l_5_5);
		state.p_AtRes.set(E_Resources.r6, E_Locations.l_2_5);
		state.p_AtRes.set(E_Resources.r16, E_Locations.l_5_4);
		state.p_AtRes.set(E_Resources.r12, E_Locations.l_4_3);
