package cz.cuni.mff.perestroika.perestroika_problem_25_3_0_5_0_1_9;
...
public class Goal extends PDDLGoal {
	...
	public boolean isAchieved(State state) {
		return    state.p_Alive.isSet()
			   ...
			   && state.p_Taken.isSet(E_Resources.r194)
			   && state.p_Taken.isSet(E_Resources.r195)
			   && state.p_Taken.isSet(E_Resources.r196)
			   && state.p_Taken.isSet(E_Resources.r197)
			   && state.p_Taken.isSet(E_Resources.r198)
			   && state.p_Taken.isSet(E_Resources.r199)
			   && state.p_Taken.isSet(E_Resources.r200)
			   && state.p_Taken.isSet(E_Resources.r201)
			   && state.p_Taken.isSet(E_Resources.r202)
			   && state.p_Taken.isSet(E_Resources.r203)
			   && state.p_Taken.isSet(E_Resources.r204)
			   && state.p_Taken.isSet(E_Resources.r205)
			   && state.p_Taken.isSet(E_Resources.r206)
			   && state.p_Taken.isSet(E_Resources.r207)
			   && state.p_Taken.isSet(E_Resources.r208)
			   && state.p_Taken.isSet(E_Resources.r209)
			   && state.p_Taken.isSet(E_Resources.r210)
			   && state.p_Taken.isSet(E_Resources.r211)
			   && state.p_Taken.isSet(E_Resources.r212)
			   && state.p_Taken.isSet(E_Resources.r213)
			   && state.p_Taken.isSet(E_Resources.r214)
			   && state.p_Taken.isSet(E_Resources.r215)
			   && state.p_Taken.isSet(E_Resources.r216)
			   && state.p_Taken.isSet(E_Resources.r217)
			   && state.p_Taken.isSet(E_Resources.r218)
			   && state.p_Taken.isSet(E_Resources.r219)
			   && state.p_Taken.isSet(E_Resources.r220)
			   && state.p_Taken.isSet(E_Resources.r221)
			   && state.p_Taken.isSet(E_Resources.r222)
			   && state.p_Taken.isSet(E_Resources.r223)
			   && state.p_Taken.isSet(E_Resources.r224)
			   && state.p_Taken.isSet(E_Resources.r225)
			   && state.p_Taken.isSet(E_Resources.r226)
			   && state.p_Taken.isSet(E_Resources.r227)
			   && state.p_Taken.isSet(E_Resources.r228)
			   && state.p_Taken.isSet(E_Resources.r229)
			   && state.p_Taken.isSet(E_Resources.r230)
			   && state.p_Taken.isSet(E_Resources.r231)
			   && state.p_Taken.isSet(E_Resources.r232)
			   && state.p_Taken.isSet(E_Resources.r233)
			   && state.p_Taken.isSet(E_Resources.r234)
			   && state.p_Taken.isSet(E_Resources.r235)
			   && state.p_Taken.isSet(E_Resources.r236)
			   && state.p_Taken.isSet(E_Resources.r237)
			   && state.p_Taken.isSet(E_Resources.r238)
			   && state.p_Taken.isSet(E_Resources.r239)
			   && state.p_Taken.isSet(E_Resources.r240)
			   && state.p_Taken.isSet(E_Resources.r241)
			   && state.p_Taken.isSet(E_Resources.r242)
			   && state.p_Taken.isSet(E_Resources.r243)
			   && state.p_Taken.isSet(E_Resources.r244)
			   && state.p_Taken.isSet(E_Resources.r245)
			   && state.p_Taken.isSet(E_Resources.r246)
			   && state.p_Taken.isSet(E_Resources.r247)
			   && state.p_Taken.isSet(E_Resources.r248)
			   && state.p_Taken.isSet(E_Resources.r249)
			   && state.p_Taken.isSet(E_Resources.r250)
			   && state.p_Taken.isSet(E_Resources.r251)
			   && state.p_Taken.isSet(E_Resources.r252)
			   && state.p_Taken.isSet(E_Resources.r253)
			   && state.p_Taken.isSet(E_Resources.r254)
			   && state.p_Taken.isSet(E_Resources.r255)
			   && state.p_Taken.isSet(E_Resources.r256)
			   && state.p_Taken.isSet(E_Resources.r257)
			   && state.p_Taken.isSet(E_Resources.r258)
			   && state.p_Taken.isSet(E_Resources.r259)
			   && state.p_Taken.isSet(E_Resources.r260)
			   && state.p_Taken.isSet(E_Resources.r261)
			   && state.p_Taken.isSet(E_Resources.r262)
			   && state.p_Taken.isSet(E_Resources.r263)
			   && state.p_Taken.isSet(E_Resources.r264)
			   && state.p_Taken.isSet(E_Resources.r265)
			   && state.p_Taken.isSet(E_Resources.r266)
			   && state.p_Taken.isSet(E_Resources.r267)
			   && state.p_Taken.isSet(E_Resources.r268)
			   && state.p_Taken.isSet(E_Resources.r269)
			   && state.p_Taken.isSet(E_Resources.r270)
			   && state.p_Taken.isSet(E_Resources.r271)
			   && state.p_Taken.isSet(E_Resources.r272)
			   && state.p_Taken.isSet(E_Resources.r273)
			   && state.p_Taken.isSet(E_Resources.r274)
			   && state.p_Taken.isSet(E_Resources.r275)
			   && state.p_Taken.isSet(E_Resources.r276)
			   && state.p_Taken.isSet(E_Resources.r277)
			   && state.p_Taken.isSet(E_Resources.r278)
			   && state.p_Taken.isSet(E_Resources.r279)
			   && state.p_Taken.isSet(E_Resources.r280)
			   && state.p_Taken.isSet(E_Resources.r281)
			   && state.p_Taken.isSet(E_Resources.r282)
			   && state.p_Taken.isSet(E_Resources.r283)
			   && state.p_Taken.isSet(E_Resources.r284)
			   && state.p_Taken.isSet(E_Resources.r285)
			   && state.p_Taken.isSet(E_Resources.r286)
			   && state.p_Taken.isSet(E_Resources.r287);
	}
	...
	public boolean isAchievedUnion(State... states) {
		...
		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r194)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r195)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r196)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r197)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r198)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r199)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r200)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r201)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r202)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r203)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r204)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r205)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r206)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r207)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r208)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r209)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r210)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r211)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r212)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r213)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r214)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r215)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r216)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r217)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r218)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r219)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r220)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r221)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r222)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r223)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r224)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r225)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r226)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r227)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r228)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r229)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r230)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r231)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r232)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r233)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r234)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r235)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r236)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r237)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r238)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r239)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r240)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r241)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r242)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r243)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r244)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r245)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r246)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r247)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r248)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r249)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r250)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r251)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r252)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r253)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r254)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r255)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r256)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r257)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r258)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r259)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r260)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r261)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r262)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r263)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r264)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r265)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r266)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r267)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r268)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r269)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r270)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r271)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r272)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r273)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r274)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r275)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r276)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r277)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r278)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r279)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r280)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r281)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r282)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r283)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r284)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r285)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r286)) break;
		}
		if (!achieved) return false;

		achieved = false;
		for (State state : states) {
			if (achieved = state.p_Taken.isSet(E_Resources.r287)) break;
		}
		if (!achieved) return false;
