...
public final class Problem extends PerestroikaProblem {
	...
	public Problem() {
		...
		state.p_AtRes.set(E_Resources.r20, E_Locations.l_15_2);
		...
		state.p_AtRes.set(E_Resources.r9, E_Locations.l_6_3);
		...
		state.p_AtRes.set(E_Resources.r12, E_Locations.l_8_6);
		state.p_AtRes.set(E_Resources.r14, E_Locations.l_9_14);
		...
		state.p_AtRes.set(E_Resources.r13, E_Locations.l_8_12);
