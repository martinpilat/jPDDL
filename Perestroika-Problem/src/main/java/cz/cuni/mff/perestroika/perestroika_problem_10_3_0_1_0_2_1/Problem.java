...
public final class Problem extends PerestroikaProblem {
	...
	public Problem() {
		...
		state.p_AtRes.set(E_Resources.r5, E_Locations.l_8_8);
		state.p_AtRes.set(E_Resources.r10, E_Locations.l_10_6);
		state.p_AtRes.set(E_Resources.r8, E_Locations.l_9_7);
		state.p_AtRes.set(E_Resources.r7, E_Locations.l_9_5);
		state.p_AtRes.set(E_Resources.r6, E_Locations.l_8_10);
		state.p_AtRes.set(E_Resources.r1, E_Locations.l_3_7);
		state.p_AtRes.set(E_Resources.r3, E_Locations.l_6_6);
		state.p_AtRes.set(E_Resources.r9, E_Locations.l_10_2);
		state.p_AtRes.set(E_Resources.r2, E_Locations.l_3_9);
		state.p_AtRes.set(E_Resources.r4, E_Locations.l_7_3);
