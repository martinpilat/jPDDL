...
public final class Problem extends PerestroikaProblem {
	...
	public Problem() {
		...
		state.p_AtRes.set(E_Resources.r13, E_Locations.l_12_14);
		state.p_AtRes.set(E_Resources.r9, E_Locations.l_8_10);
		state.p_AtRes.set(E_Resources.r7, E_Locations.l_8_4);
		state.p_AtRes.set(E_Resources.r12, E_Locations.l_10_4);
		state.p_AtRes.set(E_Resources.r8, E_Locations.l_8_7);
		state.p_AtRes.set(E_Resources.r10, E_Locations.l_9_6);
		state.p_AtRes.set(E_Resources.r11, E_Locations.l_10_1);
		state.p_AtRes.set(E_Resources.r4, E_Locations.l_5_15);
		state.p_AtRes.set(E_Resources.r14, E_Locations.l_13_1);
		state.p_AtRes.set(E_Resources.r3, E_Locations.l_5_8);
		state.p_AtRes.set(E_Resources.r16, E_Locations.l_15_7);
