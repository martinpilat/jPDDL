...
public final class Problem extends PerestroikaProblem {
	...
	public Problem() {
		...
		state.p_AtRes.set(E_Resources.r6, E_Locations.l_10_14);
		state.p_AtRes.set(E_Resources.r5, E_Locations.l_9_7);
		state.p_AtRes.set(E_Resources.r10, E_Locations.l_13_3);
		state.p_AtRes.set(E_Resources.r3, E_Locations.l_8_6);
		state.p_AtRes.set(E_Resources.r8, E_Locations.l_11_9);
		state.p_AtRes.set(E_Resources.r7, E_Locations.l_11_4);
		state.p_AtRes.set(E_Resources.r1, E_Locations.l_2_9);
		state.p_AtRes.set(E_Resources.r9, E_Locations.l_12_8);
		state.p_AtRes.set(E_Resources.r4, E_Locations.l_8_15);
		state.p_AtRes.set(E_Resources.r2, E_Locations.l_6_6);
