...
public final class Problem extends PerestroikaProblem {
	...
	public Problem() {
		...
		state.p_AtRes.set(E_Resources.r6, E_Locations.l_6_13);
		...
		state.p_AtRes.set(E_Resources.r22, E_Locations.l_13_14);
		state.p_AtRes.set(E_Resources.r23, E_Locations.l_14_9);
		state.p_AtRes.set(E_Resources.r10, E_Locations.l_9_2);
