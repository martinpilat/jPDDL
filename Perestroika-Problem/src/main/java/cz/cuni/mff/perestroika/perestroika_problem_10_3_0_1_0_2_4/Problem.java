...
public final class Problem extends PerestroikaProblem {
	...
	public Problem() {
		...
		state.p_AtRes.set(E_Resources.r2, E_Locations.l_6_8);
		state.p_AtRes.set(E_Resources.r3, E_Locations.l_7_2);
		state.p_AtRes.set(E_Resources.r5, E_Locations.l_10_5);
