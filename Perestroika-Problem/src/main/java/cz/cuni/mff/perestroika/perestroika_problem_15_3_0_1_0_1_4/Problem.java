...
public final class Problem extends PerestroikaProblem {
	...
	public Problem() {
		...
		state.p_AtRes.set(E_Resources.r13, E_Locations.l_12_2);
		...
		state.p_AtRes.set(E_Resources.r17, E_Locations.l_13_14);
		state.p_AtRes.set(E_Resources.r2, E_Locations.l_3_10);
		state.p_AtRes.set(E_Resources.r14, E_Locations.l_13_7);
		state.p_AtRes.set(E_Resources.r3, E_Locations.l_3_14);
		state.p_AtRes.set(E_Resources.r8, E_Locations.l_8_5);
		state.p_AtRes.set(E_Resources.r21, E_Locations.l_15_15);
		state.p_AtRes.set(E_Resources.r10, E_Locations.l_8_13);
		state.p_AtRes.set(E_Resources.r5, E_Locations.l_5_12);
		state.p_AtRes.set(E_Resources.r19, E_Locations.l_14_3);
		state.p_AtRes.set(E_Resources.r15, E_Locations.l_13_9);
		state.p_AtRes.set(E_Resources.r16, E_Locations.l_13_12);
		state.p_AtRes.set(E_Resources.r9, E_Locations.l_8_6);
		state.p_AtRes.set(E_Resources.r20, E_Locations.l_15_1);
		state.p_AtRes.set(E_Resources.r4, E_Locations.l_4_2);
		state.p_AtRes.set(E_Resources.r12, E_Locations.l_10_7);
