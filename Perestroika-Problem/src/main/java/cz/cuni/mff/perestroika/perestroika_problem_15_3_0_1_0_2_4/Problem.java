...
public final class Problem extends PerestroikaProblem {
	...
	public Problem() {
		...
		state.p_AtRes.set(E_Resources.r11, E_Locations.l_8_15);
		state.p_AtRes.set(E_Resources.r2, E_Locations.l_3_12);
		state.p_AtRes.set(E_Resources.r13, E_Locations.l_10_1);
		state.p_AtRes.set(E_Resources.r17, E_Locations.l_13_5);
		state.p_AtRes.set(E_Resources.r18, E_Locations.l_13_7);
		state.p_AtRes.set(E_Resources.r3, E_Locations.l_3_14);
		state.p_AtRes.set(E_Resources.r14, E_Locations.l_10_9);
		state.p_AtRes.set(E_Resources.r12, E_Locations.l_9_15);
		state.p_AtRes.set(E_Resources.r4, E_Locations.l_3_15);
		state.p_AtRes.set(E_Resources.r1, E_Locations.l_3_4);
		state.p_AtRes.set(E_Resources.r9, E_Locations.l_7_6);
		state.p_AtRes.set(E_Resources.r10, E_Locations.l_8_5);
		state.p_AtRes.set(E_Resources.r20, E_Locations.l_14_4);
		state.p_AtRes.set(E_Resources.r15, E_Locations.l_10_13);
		state.p_AtRes.set(E_Resources.r19, E_Locations.l_13_13);
