...
public final class Problem extends PerestroikaProblem {
	...
	public Problem() {
		...
		state.p_AtRes.set(E_Resources.r3, E_Locations.l_9_1);
		state.p_AtRes.set(E_Resources.r1, E_Locations.l_7_4);
		state.p_AtRes.set(E_Resources.r2, E_Locations.l_8_7);
		state.p_AtRes.set(E_Resources.r4, E_Locations.l_9_10);
		state.p_AtRes.set(E_Resources.r5, E_Locations.l_10_3);
