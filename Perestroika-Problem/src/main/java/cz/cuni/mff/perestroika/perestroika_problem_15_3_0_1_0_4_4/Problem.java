...
public final class Problem extends PerestroikaProblem {
	...
	public Problem() {
		...
		state.p_AtRes.set(E_Resources.r5, E_Locations.l_6_10);
		state.p_AtRes.set(E_Resources.r11, E_Locations.l_10_10);
		state.p_AtRes.set(E_Resources.r7, E_Locations.l_7_5);
		state.p_AtRes.set(E_Resources.r14, E_Locations.l_14_2);
		state.p_AtRes.set(E_Resources.r4, E_Locations.l_5_9);
		state.p_AtRes.set(E_Resources.r2, E_Locations.l_4_5);
		state.p_AtRes.set(E_Resources.r6, E_Locations.l_7_4);
		...
		state.p_AtRes.set(E_Resources.r3, E_Locations.l_5_6);
