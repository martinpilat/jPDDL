...
public final class Problem extends PerestroikaProblem {
	...
	public Problem() {
		...
		state.p_AtRes.set(E_Resources.r7, E_Locations.l_11_6);
		state.p_AtRes.set(E_Resources.r5, E_Locations.l_7_15);
		state.p_AtRes.set(E_Resources.r9, E_Locations.l_12_15);
		state.p_AtRes.set(E_Resources.r2, E_Locations.l_2_1);
		state.p_AtRes.set(E_Resources.r4, E_Locations.l_7_11);
		state.p_AtRes.set(E_Resources.r8, E_Locations.l_12_7);
