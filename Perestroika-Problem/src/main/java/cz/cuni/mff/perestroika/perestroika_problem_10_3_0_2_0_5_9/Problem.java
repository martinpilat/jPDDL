...
public final class Problem extends PerestroikaProblem {
	...
	public Problem() {
		...
		state.p_AtRes.set(E_Resources.r2, E_Locations.l_5_6);
		state.p_AtRes.set(E_Resources.r7, E_Locations.l_9_10);
		state.p_AtRes.set(E_Resources.r4, E_Locations.l_8_7);
		state.p_AtRes.set(E_Resources.r6, E_Locations.l_9_8);
		state.p_AtRes.set(E_Resources.r1, E_Locations.l_2_5);
		state.p_AtRes.set(E_Resources.r5, E_Locations.l_9_7);
		state.p_AtRes.set(E_Resources.r3, E_Locations.l_8_5);
