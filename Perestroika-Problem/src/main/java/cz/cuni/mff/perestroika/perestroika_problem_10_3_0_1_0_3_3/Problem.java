...
public final class Problem extends PerestroikaProblem {
	...
	public Problem() {
		...
		state.p_AtRes.set(E_Resources.r5, E_Locations.l_8_6);
		...
		state.p_AtRes.set(E_Resources.r6, E_Locations.l_8_10);
		state.p_AtRes.set(E_Resources.r4, E_Locations.l_7_5);
