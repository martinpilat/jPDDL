...
public final class Problem extends PerestroikaProblem {
	...
	public Problem() {
		...
		state.p_AtRes.set(E_Resources.r10, E_Locations.l_14_6);
		state.p_AtRes.set(E_Resources.r1, E_Locations.l_1_11);
		state.p_AtRes.set(E_Resources.r4, E_Locations.l_6_5);
		state.p_AtRes.set(E_Resources.r8, E_Locations.l_13_5);
		state.p_AtRes.set(E_Resources.r9, E_Locations.l_14_3);
		state.p_AtRes.set(E_Resources.r3, E_Locations.l_5_9);
		state.p_AtRes.set(E_Resources.r11, E_Locations.l_15_15);
		state.p_AtRes.set(E_Resources.r7, E_Locations.l_13_4);
