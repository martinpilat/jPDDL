...
public final class Problem extends PerestroikaProblem {
	...
	public Problem() {
		...
		state.p_AtRes.set(E_Resources.r10, E_Locations.l_14_3);
		state.p_AtRes.set(E_Resources.r7, E_Locations.l_7_11);
		state.p_AtRes.set(E_Resources.r1, E_Locations.l_1_4);
		state.p_AtRes.set(E_Resources.r5, E_Locations.l_5_6);
		state.p_AtRes.set(E_Resources.r6, E_Locations.l_7_1);
		state.p_AtRes.set(E_Resources.r8, E_Locations.l_11_8);
