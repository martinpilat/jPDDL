...
public final class Problem extends PerestroikaProblem {
	...
	public Problem() {
		...
		state.p_AtRes.set(E_Resources.r5, E_Locations.l_5_5);
		state.p_AtRes.set(E_Resources.r1, E_Locations.l_3_1);
		state.p_AtRes.set(E_Resources.r4, E_Locations.l_5_1);
		state.p_AtRes.set(E_Resources.r3, E_Locations.l_4_5);
		state.p_AtRes.set(E_Resources.r2, E_Locations.l_4_3);
