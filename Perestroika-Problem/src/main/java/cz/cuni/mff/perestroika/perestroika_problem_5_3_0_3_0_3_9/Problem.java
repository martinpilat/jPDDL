...
public final class Problem extends PerestroikaProblem {
	...
	public Problem() {
		...
		state.p_AtRes.set(E_Resources.r7, E_Locations.l_3_2);
		...
		state.p_AtRes.set(E_Resources.r1, E_Locations.l_1_4);
		state.p_AtRes.set(E_Resources.r2, E_Locations.l_1_5);
		state.p_AtRes.set(E_Resources.r6, E_Locations.l_3_1);
