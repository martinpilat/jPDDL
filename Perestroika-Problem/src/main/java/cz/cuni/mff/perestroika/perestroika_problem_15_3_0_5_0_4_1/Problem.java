...
public final class Problem extends PerestroikaProblem {
	...
	public Problem() {
		...
		state.p_AtRes.set(E_Resources.r44, E_Locations.l_11_12);
		...
		state.p_AtRes.set(E_Resources.r47, E_Locations.l_12_1);
		state.p_AtRes.set(E_Resources.r56, E_Locations.l_14_4);
		...
		state.p_AtRes.set(E_Resources.r59, E_Locations.l_15_2);
		state.p_AtRes.set(E_Resources.r15, E_Locations.l_4_3);
		state.p_AtRes.set(E_Resources.r43, E_Locations.l_11_3);
		...
		state.p_AtRes.set(E_Resources.r28, E_Locations.l_7_6);
