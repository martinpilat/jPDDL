...
public final class Problem extends PerestroikaProblem {
	...
	public Problem() {
		...
		state.p_AtRes.set(E_Resources.r3, E_Locations.l_3_2);
		state.p_AtRes.set(E_Resources.r1, E_Locations.l_1_3);
		state.p_AtRes.set(E_Resources.r5, E_Locations.l_4_1);
		state.p_AtRes.set(E_Resources.r6, E_Locations.l_4_2);
		...
		state.p_Small.set(E_Locations.l_5_3);
