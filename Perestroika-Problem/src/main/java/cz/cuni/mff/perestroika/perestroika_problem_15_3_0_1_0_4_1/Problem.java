...
public final class Problem extends PerestroikaProblem {
	...
	public Problem() {
		...
		state.p_AtRes.set(E_Resources.r4, E_Locations.l_7_4);
		state.p_AtRes.set(E_Resources.r13, E_Locations.l_12_12);
		state.p_AtRes.set(E_Resources.r10, E_Locations.l_11_5);
		state.p_AtRes.set(E_Resources.r11, E_Locations.l_11_10);
		state.p_AtRes.set(E_Resources.r6, E_Locations.l_8_13);
		state.p_AtRes.set(E_Resources.r1, E_Locations.l_1_5);
		state.p_AtRes.set(E_Resources.r7, E_Locations.l_9_7);
		state.p_AtRes.set(E_Resources.r8, E_Locations.l_11_1);
		state.p_AtRes.set(E_Resources.r14, E_Locations.l_14_13);
		state.p_AtRes.set(E_Resources.r9, E_Locations.l_11_3);
		state.p_AtRes.set(E_Resources.r3, E_Locations.l_5_4);
		state.p_AtRes.set(E_Resources.r2, E_Locations.l_2_15);
		state.p_AtRes.set(E_Resources.r15, E_Locations.l_15_4);
		state.p_AtRes.set(E_Resources.r5, E_Locations.l_7_9);
		state.p_AtRes.set(E_Resources.r12, E_Locations.l_12_5);
