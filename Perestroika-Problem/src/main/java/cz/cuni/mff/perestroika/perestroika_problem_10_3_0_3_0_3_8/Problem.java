...
public final class Problem extends PerestroikaProblem {
	...
	public Problem() {
		...
		state.p_AtRes.set(E_Resources.r26, E_Locations.l_10_10);
		state.p_AtRes.set(E_Resources.r8, E_Locations.l_4_8);
		state.p_AtRes.set(E_Resources.r16, E_Locations.l_8_4);
		state.p_AtRes.set(E_Resources.r25, E_Locations.l_10_9);
