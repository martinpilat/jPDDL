...
public final class Problem extends PerestroikaProblem {
	...
	public Problem() {
		...
		state.p_AtRes.set(E_Resources.r9, E_Locations.l_11_15);
		state.p_AtRes.set(E_Resources.r13, E_Locations.l_13_14);
		state.p_AtRes.set(E_Resources.r3, E_Locations.l_4_7);
		state.p_AtRes.set(E_Resources.r1, E_Locations.l_1_12);
		state.p_AtRes.set(E_Resources.r12, E_Locations.l_12_11);
		state.p_AtRes.set(E_Resources.r18, E_Locations.l_15_15);
		state.p_AtRes.set(E_Resources.r17, E_Locations.l_15_8);
		state.p_AtRes.set(E_Resources.r4, E_Locations.l_5_12);
		state.p_AtRes.set(E_Resources.r14, E_Locations.l_14_6);
		state.p_AtRes.set(E_Resources.r15, E_Locations.l_14_10);
		state.p_AtRes.set(E_Resources.r16, E_Locations.l_14_14);
		state.p_AtRes.set(E_Resources.r7, E_Locations.l_10_1);
		state.p_AtRes.set(E_Resources.r8, E_Locations.l_11_10);
		state.p_AtRes.set(E_Resources.r11, E_Locations.l_12_10);
		state.p_AtRes.set(E_Resources.r10, E_Locations.l_12_9);
		state.p_AtRes.set(E_Resources.r5, E_Locations.l_6_2);
		state.p_AtRes.set(E_Resources.r2, E_Locations.l_2_10);
		state.p_AtRes.set(E_Resources.r6, E_Locations.l_6_3);
