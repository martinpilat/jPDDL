...
public final class Problem extends PerestroikaProblem {
	...
	public Problem() {
		...
		state.p_AtRes.set(E_Resources.r15, E_Locations.l_14_11);
		state.p_AtRes.set(E_Resources.r4, E_Locations.l_3_4);
		state.p_AtRes.set(E_Resources.r6, E_Locations.l_3_14);
		state.p_AtRes.set(E_Resources.r12, E_Locations.l_11_14);
		state.p_AtRes.set(E_Resources.r5, E_Locations.l_3_7);
		state.p_AtRes.set(E_Resources.r11, E_Locations.l_11_5);
		state.p_AtRes.set(E_Resources.r1, E_Locations.l_1_7);
		state.p_AtRes.set(E_Resources.r10, E_Locations.l_10_6);
		state.p_AtRes.set(E_Resources.r2, E_Locations.l_2_2);
		state.p_AtRes.set(E_Resources.r7, E_Locations.l_4_2);
		state.p_AtRes.set(E_Resources.r13, E_Locations.l_12_11);
		state.p_AtRes.set(E_Resources.r9, E_Locations.l_8_11);
