...
public final class Problem extends PerestroikaProblem {
	...
	public Problem() {
		...
		state.p_AtRes.set(E_Resources.r6, E_Locations.l_11_3);
		state.p_AtRes.set(E_Resources.r7, E_Locations.l_11_12);
		state.p_AtRes.set(E_Resources.r9, E_Locations.l_15_4);
		state.p_AtRes.set(E_Resources.r4, E_Locations.l_6_14);
		state.p_AtRes.set(E_Resources.r5, E_Locations.l_10_15);
		state.p_AtRes.set(E_Resources.r3, E_Locations.l_6_13);
		state.p_AtRes.set(E_Resources.r2, E_Locations.l_5_14);
		state.p_AtRes.set(E_Resources.r8, E_Locations.l_12_5);
