...
public final class Problem extends PerestroikaProblem {
	...
	public Problem() {
		...
		state.p_AtRes.set(E_Resources.r8, E_Locations.l_6_6);
		state.p_AtRes.set(E_Resources.r21, E_Locations.l_12_8);
		state.p_AtRes.set(E_Resources.r4, E_Locations.l_4_12);
		state.p_AtRes.set(E_Resources.r9, E_Locations.l_7_8);
		state.p_AtRes.set(E_Resources.r27, E_Locations.l_14_6);
		state.p_AtRes.set(E_Resources.r18, E_Locations.l_11_9);
		state.p_AtRes.set(E_Resources.r20, E_Locations.l_12_4);
		state.p_AtRes.set(E_Resources.r29, E_Locations.l_14_14);
		state.p_AtRes.set(E_Resources.r11, E_Locations.l_8_3);
		state.p_AtRes.set(E_Resources.r23, E_Locations.l_13_11);
		state.p_AtRes.set(E_Resources.r25, E_Locations.l_14_4);
		state.p_AtRes.set(E_Resources.r22, E_Locations.l_12_11);
		state.p_AtRes.set(E_Resources.r10, E_Locations.l_7_15);
		state.p_AtRes.set(E_Resources.r24, E_Locations.l_14_2);
		state.p_AtRes.set(E_Resources.r14, E_Locations.l_10_10);
		state.p_AtRes.set(E_Resources.r12, E_Locations.l_10_3);
		state.p_AtRes.set(E_Resources.r16, E_Locations.l_11_3);
		state.p_AtRes.set(E_Resources.r13, E_Locations.l_10_5);
		state.p_AtRes.set(E_Resources.r17, E_Locations.l_11_4);
		state.p_AtRes.set(E_Resources.r15, E_Locations.l_10_15);
		...
		state.p_AtRes.set(E_Resources.r28, E_Locations.l_14_7);
		...
		state.p_AtRes.set(E_Resources.r6, E_Locations.l_5_11);
