...
public final class Problem extends PerestroikaProblem {
	...
	public Problem() {
		...
		state.p_AtRes.set(E_Resources.r3, E_Locations.l_4_1);
		state.p_AtRes.set(E_Resources.r2, E_Locations.l_3_5);
		state.p_AtRes.set(E_Resources.r4, E_Locations.l_4_2);
		state.p_AtRes.set(E_Resources.r6, E_Locations.l_5_4);
		state.p_AtRes.set(E_Resources.r5, E_Locations.l_5_2);
