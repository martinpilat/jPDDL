...
public final class Problem extends PerestroikaProblem {
	...
	public Problem() {
		...
		state.p_AtRes.set(E_Resources.r3, E_Locations.l_10_13);
		state.p_AtRes.set(E_Resources.r6, E_Locations.l_11_12);
		state.p_AtRes.set(E_Resources.r8, E_Locations.l_14_2);
		state.p_AtRes.set(E_Resources.r7, E_Locations.l_12_5);
		state.p_AtRes.set(E_Resources.r5, E_Locations.l_11_9);
		state.p_AtRes.set(E_Resources.r4, E_Locations.l_11_6);
		state.p_AtRes.set(E_Resources.r2, E_Locations.l_8_10);
		state.p_AtRes.set(E_Resources.r1, E_Locations.l_3_11);
