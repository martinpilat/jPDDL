...
public final class Problem extends PerestroikaProblem {
	...
	public Problem() {
		...
		state.p_AtRes.set(E_Resources.r9, E_Locations.l_15_9);
		state.p_AtRes.set(E_Resources.r1, E_Locations.l_3_12);
		state.p_AtRes.set(E_Resources.r2, E_Locations.l_4_8);
		state.p_AtRes.set(E_Resources.r6, E_Locations.l_12_12);
		state.p_AtRes.set(E_Resources.r4, E_Locations.l_8_2);
		state.p_AtRes.set(E_Resources.r5, E_Locations.l_8_3);
		state.p_AtRes.set(E_Resources.r3, E_Locations.l_8_1);
		state.p_AtRes.set(E_Resources.r7, E_Locations.l_13_11);
		state.p_AtRes.set(E_Resources.r8, E_Locations.l_15_3);
