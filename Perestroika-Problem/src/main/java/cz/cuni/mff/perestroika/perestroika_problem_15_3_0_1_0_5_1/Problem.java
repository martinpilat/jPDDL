...
public final class Problem extends PerestroikaProblem {
	...
	public Problem() {
		...
		state.p_AtRes.set(E_Resources.r11, E_Locations.l_15_2);
		state.p_AtRes.set(E_Resources.r2, E_Locations.l_3_2);
		state.p_AtRes.set(E_Resources.r4, E_Locations.l_3_5);
		state.p_AtRes.set(E_Resources.r10, E_Locations.l_14_10);
		state.p_AtRes.set(E_Resources.r7, E_Locations.l_4_7);
		state.p_AtRes.set(E_Resources.r12, E_Locations.l_15_8);
		state.p_AtRes.set(E_Resources.r3, E_Locations.l_3_3);
		state.p_AtRes.set(E_Resources.r9, E_Locations.l_13_13);
