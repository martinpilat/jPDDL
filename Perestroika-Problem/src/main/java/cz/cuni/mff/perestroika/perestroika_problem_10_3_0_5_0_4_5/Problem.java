...
public final class Problem extends PerestroikaProblem {
	...
	public Problem() {
		...
		state.p_AtRes.set(E_Resources.r6, E_Locations.l_3_6);
		...
		state.p_AtRes.set(E_Resources.r27, E_Locations.l_10_5);
		...
		state.p_AtRes.set(E_Resources.r23, E_Locations.l_9_5);
