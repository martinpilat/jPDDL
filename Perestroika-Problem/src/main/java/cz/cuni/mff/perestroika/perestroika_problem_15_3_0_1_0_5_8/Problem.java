...
public final class Problem extends PerestroikaProblem {
	...
	public Problem() {
		...
		state.p_AtRes.set(E_Resources.r7, E_Locations.l_9_1);
		state.p_AtRes.set(E_Resources.r6, E_Locations.l_6_15);
		state.p_AtRes.set(E_Resources.r4, E_Locations.l_2_9);
		state.p_AtRes.set(E_Resources.r5, E_Locations.l_4_12);
		state.p_AtRes.set(E_Resources.r8, E_Locations.l_10_6);
		state.p_AtRes.set(E_Resources.r3, E_Locations.l_2_7);
		state.p_AtRes.set(E_Resources.r1, E_Locations.l_1_2);
		state.p_AtRes.set(E_Resources.r9, E_Locations.l_14_10);
