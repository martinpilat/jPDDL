...
public final class Problem extends PerestroikaProblem {
	...
	public Problem() {
		...
		state.p_AtRes.set(E_Resources.r1, E_Locations.l_2_2);
		state.p_AtRes.set(E_Resources.r6, E_Locations.l_3_4);
		state.p_AtRes.set(E_Resources.r4, E_Locations.l_3_1);
		state.p_AtRes.set(E_Resources.r2, E_Locations.l_2_3);
		state.p_AtRes.set(E_Resources.r10, E_Locations.l_5_3);
		state.p_AtRes.set(E_Resources.r11, E_Locations.l_5_4);
