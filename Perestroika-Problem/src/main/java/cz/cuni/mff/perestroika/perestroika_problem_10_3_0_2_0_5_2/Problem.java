...
public final class Problem extends PerestroikaProblem {
	...
	public Problem() {
		...
		state.p_AtRes.set(E_Resources.r7, E_Locations.l_10_10);
		state.p_AtRes.set(E_Resources.r3, E_Locations.l_8_6);
		state.p_AtRes.set(E_Resources.r6, E_Locations.l_10_6);
		state.p_AtRes.set(E_Resources.r2, E_Locations.l_7_10);
		state.p_AtRes.set(E_Resources.r1, E_Locations.l_6_1);
