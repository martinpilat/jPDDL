...
public final class Problem extends PerestroikaProblem {
	...
	public Problem() {
		...
		state.p_AtRes.set(E_Resources.r41, E_Locations.l_10_3);
		...
		state.p_AtRes.set(E_Resources.r42, E_Locations.l_10_4);
		state.p_AtRes.set(E_Resources.r40, E_Locations.l_10_1);
