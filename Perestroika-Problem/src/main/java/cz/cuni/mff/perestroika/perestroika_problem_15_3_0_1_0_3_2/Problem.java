...
public final class Problem extends PerestroikaProblem {
	...
	public Problem() {
		...
		state.p_AtRes.set(E_Resources.r16, E_Locations.l_11_2);
		state.p_AtRes.set(E_Resources.r1, E_Locations.l_1_12);
		state.p_AtRes.set(E_Resources.r18, E_Locations.l_13_8);
		state.p_AtRes.set(E_Resources.r9, E_Locations.l_5_6);
		state.p_AtRes.set(E_Resources.r22, E_Locations.l_15_5);
		state.p_AtRes.set(E_Resources.r12, E_Locations.l_9_4);
		state.p_AtRes.set(E_Resources.r11, E_Locations.l_8_7);
		state.p_AtRes.set(E_Resources.r6, E_Locations.l_4_2);
		state.p_AtRes.set(E_Resources.r14, E_Locations.l_9_8);
		...
		state.p_AtRes.set(E_Resources.r20, E_Locations.l_14_5);
		state.p_AtRes.set(E_Resources.r23, E_Locations.l_15_6);
		state.p_AtRes.set(E_Resources.r24, E_Locations.l_15_11);
