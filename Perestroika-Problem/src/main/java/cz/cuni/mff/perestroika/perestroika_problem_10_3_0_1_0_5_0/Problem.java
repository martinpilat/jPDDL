...
public final class Problem extends PerestroikaProblem {
	...
	public Problem() {
		...
		state.p_AtRes.set(E_Resources.r3, E_Locations.l_8_9);
		state.p_AtRes.set(E_Resources.r1, E_Locations.l_5_8);
		state.p_AtRes.set(E_Resources.r4, E_Locations.l_9_3);
		state.p_AtRes.set(E_Resources.r2, E_Locations.l_6_2);
		state.p_AtRes.set(E_Resources.r5, E_Locations.l_9_8);
