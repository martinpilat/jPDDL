...
public final class Problem extends PerestroikaProblem {
	...
	public Problem() {
		...
		state.p_AtRes.set(E_Resources.r13, E_Locations.l_7_4);
		state.p_AtRes.set(E_Resources.r7, E_Locations.l_5_13);
		...
		state.p_AtRes.set(E_Resources.r40, E_Locations.l_15_2);
		...
		state.p_AtRes.set(E_Resources.r17, E_Locations.l_8_9);
		state.p_AtRes.set(E_Resources.r31, E_Locations.l_13_3);
		state.p_AtRes.set(E_Resources.r32, E_Locations.l_13_5);
		state.p_AtRes.set(E_Resources.r12, E_Locations.l_7_1);
		...
		state.p_AtRes.set(E_Resources.r16, E_Locations.l_8_3);
