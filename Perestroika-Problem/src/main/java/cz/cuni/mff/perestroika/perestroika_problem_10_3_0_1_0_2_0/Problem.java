...
public final class Problem extends PerestroikaProblem {
	...
	public Problem() {
		...
		state.p_AtRes.set(E_Resources.r6, E_Locations.l_8_8);
		state.p_AtRes.set(E_Resources.r7, E_Locations.l_10_7);
		state.p_AtRes.set(E_Resources.r4, E_Locations.l_7_5);
		state.p_AtRes.set(E_Resources.r8, E_Locations.l_10_9);
		state.p_AtRes.set(E_Resources.r5, E_Locations.l_8_2);
