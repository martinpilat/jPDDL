...
public final class Problem extends PerestroikaProblem {
	...
	public Problem() {
		...
		state.p_AtRes.set(E_Resources.r3, E_Locations.l_2_3);
		state.p_AtRes.set(E_Resources.r7, E_Locations.l_4_3);
		state.p_AtRes.set(E_Resources.r8, E_Locations.l_4_5);
		state.p_AtRes.set(E_Resources.r5, E_Locations.l_3_4);
		state.p_AtRes.set(E_Resources.r10, E_Locations.l_5_2);
		...
		state.p_Small.set(E_Locations.l_1_5);
