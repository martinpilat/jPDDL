...
public final class Problem extends PerestroikaProblem {
	...
	public Problem() {
		...
		state.p_AtRes.set(E_Resources.r11, E_Locations.l_13_11);
		state.p_AtRes.set(E_Resources.r12, E_Locations.l_15_12);
		state.p_AtRes.set(E_Resources.r2, E_Locations.l_4_6);
		state.p_AtRes.set(E_Resources.r1, E_Locations.l_1_9);
		state.p_AtRes.set(E_Resources.r4, E_Locations.l_6_8);
		state.p_AtRes.set(E_Resources.r9, E_Locations.l_12_9);
		state.p_AtRes.set(E_Resources.r5, E_Locations.l_10_1);
		state.p_AtRes.set(E_Resources.r8, E_Locations.l_12_5);
		state.p_AtRes.set(E_Resources.r6, E_Locations.l_10_9);
		state.p_AtRes.set(E_Resources.r10, E_Locations.l_12_11);
		state.p_AtRes.set(E_Resources.r7, E_Locations.l_12_1);
