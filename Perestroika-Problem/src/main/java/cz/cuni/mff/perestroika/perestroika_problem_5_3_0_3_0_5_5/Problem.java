...
public final class Problem extends PerestroikaProblem {
	...
	public Problem() {
		...
		state.p_AtRes.set(E_Resources.r3, E_Locations.l_5_2);
		state.p_AtRes.set(E_Resources.r2, E_Locations.l_4_5);
		state.p_AtRes.set(E_Resources.r1, E_Locations.l_3_4);
