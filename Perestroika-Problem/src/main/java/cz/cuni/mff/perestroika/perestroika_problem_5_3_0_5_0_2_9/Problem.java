...
public final class Problem extends PerestroikaProblem {
	...
	public Problem() {
		...
		state.p_AtRes.set(E_Resources.r1, E_Locations.l_2_1);
		...
		state.p_AtRes.set(E_Resources.r9, E_Locations.l_5_4);
		state.p_AtRes.set(E_Resources.r7, E_Locations.l_4_1);
		state.p_AtRes.set(E_Resources.r5, E_Locations.l_3_2);
