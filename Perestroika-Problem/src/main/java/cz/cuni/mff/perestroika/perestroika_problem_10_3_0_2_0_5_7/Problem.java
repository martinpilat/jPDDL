...
public final class Problem extends PerestroikaProblem {
	...
	public Problem() {
		...
		state.p_AtRes.set(E_Resources.r8, E_Locations.l_8_3);
		state.p_AtRes.set(E_Resources.r3, E_Locations.l_3_4);
		state.p_AtRes.set(E_Resources.r9, E_Locations.l_10_1);
		...
		state.p_AtRes.set(E_Resources.r6, E_Locations.l_6_5);
