...
public final class Problem extends PerestroikaProblem {
	...
	public Problem() {
		...
		state.p_AtRes.set(E_Resources.r8, E_Locations.l_7_3);
		state.p_AtRes.set(E_Resources.r9, E_Locations.l_7_5);
		state.p_AtRes.set(E_Resources.r16, E_Locations.l_12_5);
		state.p_AtRes.set(E_Resources.r11, E_Locations.l_8_8);
		state.p_AtRes.set(E_Resources.r13, E_Locations.l_11_3);
		state.p_AtRes.set(E_Resources.r15, E_Locations.l_11_15);
		state.p_AtRes.set(E_Resources.r12, E_Locations.l_10_14);
		state.p_AtRes.set(E_Resources.r2, E_Locations.l_2_2);
		state.p_AtRes.set(E_Resources.r20, E_Locations.l_15_7);
		state.p_AtRes.set(E_Resources.r6, E_Locations.l_6_6);
		state.p_AtRes.set(E_Resources.r7, E_Locations.l_6_11);
		state.p_AtRes.set(E_Resources.r14, E_Locations.l_11_12);
		state.p_AtRes.set(E_Resources.r19, E_Locations.l_13_13);
		state.p_AtRes.set(E_Resources.r10, E_Locations.l_7_9);
		state.p_AtRes.set(E_Resources.r17, E_Locations.l_12_14);
