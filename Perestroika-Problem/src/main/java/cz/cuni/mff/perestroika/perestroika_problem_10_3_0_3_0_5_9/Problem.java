...
public final class Problem extends PerestroikaProblem {
	...
	public Problem() {
		...
		state.p_AtRes.set(E_Resources.r8, E_Locations.l_10_8);
		state.p_AtRes.set(E_Resources.r6, E_Locations.l_10_3);
		state.p_AtRes.set(E_Resources.r5, E_Locations.l_9_4);
		state.p_AtRes.set(E_Resources.r1, E_Locations.l_4_6);
		state.p_AtRes.set(E_Resources.r7, E_Locations.l_10_4);
		state.p_AtRes.set(E_Resources.r2, E_Locations.l_6_4);
		state.p_AtRes.set(E_Resources.r3, E_Locations.l_7_9);
