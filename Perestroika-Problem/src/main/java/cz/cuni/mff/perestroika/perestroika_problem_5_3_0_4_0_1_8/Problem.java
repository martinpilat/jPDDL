...
public final class Problem extends PerestroikaProblem {
	...
	public Problem() {
		...
		state.p_AtRes.set(E_Resources.r10, E_Locations.l_4_4);
		...
		state.p_AtRes.set(E_Resources.r12, E_Locations.l_5_2);
		...
		state.p_AtRes.set(E_Resources.r4, E_Locations.l_2_4);
		...
		state.p_Medium.set(E_Locations.l_4_5);
