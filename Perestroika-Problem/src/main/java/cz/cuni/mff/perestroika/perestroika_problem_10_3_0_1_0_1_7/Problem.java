...
public final class Problem extends PerestroikaProblem {
	...
	public Problem() {
		...
		state.p_AtRes.set(E_Resources.r7, E_Locations.l_7_9);
		state.p_AtRes.set(E_Resources.r4, E_Locations.l_6_1);
		state.p_AtRes.set(E_Resources.r6, E_Locations.l_7_8);
