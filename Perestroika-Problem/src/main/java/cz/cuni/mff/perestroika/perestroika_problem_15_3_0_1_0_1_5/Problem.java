...
public final class Problem extends PerestroikaProblem {
	...
	public Problem() {
		...
		state.p_AtRes.set(E_Resources.r6, E_Locations.l_8_4);
		state.p_AtRes.set(E_Resources.r4, E_Locations.l_7_1);
		state.p_AtRes.set(E_Resources.r5, E_Locations.l_7_7);
		state.p_AtRes.set(E_Resources.r7, E_Locations.l_9_9);
		state.p_AtRes.set(E_Resources.r11, E_Locations.l_11_14);
		state.p_AtRes.set(E_Resources.r13, E_Locations.l_15_5);
		state.p_AtRes.set(E_Resources.r8, E_Locations.l_10_5);
		state.p_AtRes.set(E_Resources.r9, E_Locations.l_10_6);
		state.p_AtRes.set(E_Resources.r10, E_Locations.l_10_9);
		state.p_AtRes.set(E_Resources.r2, E_Locations.l_3_10);
		state.p_AtRes.set(E_Resources.r12, E_Locations.l_13_14);
