...
public final class Problem extends PerestroikaProblem {
	...
	public Problem() {
		...
		state.p_AtRes.set(E_Resources.r15, E_Locations.l_12_15);
		...
		state.p_AtRes.set(E_Resources.r9, E_Locations.l_5_13);
		...
		state.p_AtRes.set(E_Resources.r18, E_Locations.l_14_12);
