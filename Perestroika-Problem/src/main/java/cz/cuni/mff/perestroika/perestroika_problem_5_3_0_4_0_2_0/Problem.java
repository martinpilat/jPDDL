...
public final class Problem extends PerestroikaProblem {
	...
	public Problem() {
		...
		state.p_AtRes.set(E_Resources.r8, E_Locations.l_4_2);
		state.p_AtRes.set(E_Resources.r5, E_Locations.l_3_1);
		state.p_AtRes.set(E_Resources.r2, E_Locations.l_1_4);
		state.p_AtRes.set(E_Resources.r6, E_Locations.l_3_4);
		...
		state.p_AtRes.set(E_Resources.r9, E_Locations.l_4_5);
		state.p_AtRes.set(E_Resources.r10, E_Locations.l_5_1);
		state.p_AtRes.set(E_Resources.r11, E_Locations.l_5_2);
