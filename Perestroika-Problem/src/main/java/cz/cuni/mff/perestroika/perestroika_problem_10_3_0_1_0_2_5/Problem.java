...
public final class Problem extends PerestroikaProblem {
	...
	public Problem() {
		...
		state.p_AtRes.set(E_Resources.r7, E_Locations.l_8_5);
		state.p_AtRes.set(E_Resources.r6, E_Locations.l_6_2);
		...
		state.p_AtRes.set(E_Resources.r9, E_Locations.l_10_10);
