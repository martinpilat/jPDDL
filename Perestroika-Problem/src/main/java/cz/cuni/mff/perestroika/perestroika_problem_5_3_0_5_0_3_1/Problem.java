...
public final class Problem extends PerestroikaProblem {
	...
	public Problem() {
		...
		state.p_AtRes.set(E_Resources.r4, E_Locations.l_3_5);
		state.p_AtRes.set(E_Resources.r5, E_Locations.l_4_3);
		state.p_AtRes.set(E_Resources.r3, E_Locations.l_2_5);
		state.p_AtRes.set(E_Resources.r8, E_Locations.l_5_2);
		state.p_AtRes.set(E_Resources.r6, E_Locations.l_4_4);
		state.p_AtRes.set(E_Resources.r2, E_Locations.l_2_2);
		state.p_AtRes.set(E_Resources.r9, E_Locations.l_5_3);
