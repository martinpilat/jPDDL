...
public final class Problem extends PerestroikaProblem {
	...
	public Problem() {
		...
		state.p_AtRes.set(E_Resources.r3, E_Locations.l_9_3);
		state.p_AtRes.set(E_Resources.r6, E_Locations.l_13_12);
		state.p_AtRes.set(E_Resources.r4, E_Locations.l_12_14);
		state.p_AtRes.set(E_Resources.r7, E_Locations.l_15_12);
		state.p_AtRes.set(E_Resources.r5, E_Locations.l_13_8);
		state.p_AtRes.set(E_Resources.r1, E_Locations.l_1_13);
		state.p_AtRes.set(E_Resources.r2, E_Locations.l_8_13);
