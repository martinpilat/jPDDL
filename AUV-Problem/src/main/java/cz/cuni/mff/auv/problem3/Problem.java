...
public final class Problem extends PDDLProblem {
	...
	public Problem() {
		...
		state.p_Outside.set(E_Ships.s3);
		...
		state.p_Entry.set(E_Ships.s3, E_Locations.l_6_1);
		state.p_Entry.set(E_Ships.s2, E_Locations.l_4_1);

		
		state.p_Exit.set(E_Ships.s3, E_Locations.l_6_8);
		state.p_Exit.set(E_Ships.s2, E_Locations.l_4_8);
		state.p_Exit.set(E_Ships.s, E_Locations.l_5_1);

		
		state.p_ConnectedShip.set(E_Ships.s3, E_Locations.l_6_6, E_Locations.l_6_7);
		...
		state.p_ConnectedShip.set(E_Ships.s2, E_Locations.l_4_3, E_Locations.l_4_4);
		state.p_ConnectedShip.set(E_Ships.s3, E_Locations.l_6_3, E_Locations.l_6_4);
		state.p_ConnectedShip.set(E_Ships.s3, E_Locations.l_6_7, E_Locations.l_6_8);
		state.p_ConnectedShip.set(E_Ships.s2, E_Locations.l_4_1, E_Locations.l_4_2);
		...
		state.p_ConnectedShip.set(E_Ships.s3, E_Locations.l_6_5, E_Locations.l_6_6);
		state.p_ConnectedShip.set(E_Ships.s, E_Locations.l_5_3, E_Locations.l_5_2);
		state.p_ConnectedShip.set(E_Ships.s3, E_Locations.l_6_2, E_Locations.l_6_3);
		state.p_ConnectedShip.set(E_Ships.s2, E_Locations.l_4_5, E_Locations.l_4_6);
		state.p_ConnectedShip.set(E_Ships.s2, E_Locations.l_4_6, E_Locations.l_4_7);
		state.p_ConnectedShip.set(E_Ships.s2, E_Locations.l_4_2, E_Locations.l_4_3);
		state.p_ConnectedShip.set(E_Ships.s3, E_Locations.l_6_1, E_Locations.l_6_2);
		state.p_ConnectedShip.set(E_Ships.s3, E_Locations.l_6_4, E_Locations.l_6_5);
		state.p_ConnectedShip.set(E_Ships.s2, E_Locations.l_4_4, E_Locations.l_4_5);
		state.p_ConnectedShip.set(E_Ships.s2, E_Locations.l_4_7, E_Locations.l_4_8);
	}
