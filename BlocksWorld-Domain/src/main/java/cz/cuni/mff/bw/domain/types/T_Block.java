...
public class T_Block extends T_Object {
	...
	public static int getPos(T_Block instance) {
		return instance.pos;
	}
	
	public static long getFlag(T_Block instance) {
		return instance.flag;
	}
	
	public static int getIndex(T_Block instance) {
