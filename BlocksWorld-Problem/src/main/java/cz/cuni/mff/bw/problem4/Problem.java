...
public final class Problem extends BwProblem {
	...
	public Problem() {
		...
		state.p_On.set(E_Blocks.b1, E_Blocks.b4);
		state.p_On.set(E_Blocks.b2, E_Blocks.b7);
		state.p_On.set(E_Blocks.b3, E_Blocks.b5);
		state.p_On.set(E_Blocks.b5, E_Blocks.b10);
		state.p_On.set(E_Blocks.b6, E_Blocks.b2);
		state.p_On.set(E_Blocks.b8, E_Blocks.b9);
		state.p_On.set(E_Blocks.b9, E_Blocks.b3);
		state.p_On.set(E_Blocks.b10, E_Blocks.b6);
		
		state.p_OnTable.set(E_Blocks.b4);
		state.p_OnTable.set(E_Blocks.b6);
		
		state.p_Clear.set(E_Blocks.b1);
		state.p_Clear.set(E_Blocks.b8);
