...
//			   !state.p_Movable.isSet(E_Blocks.b5) && !state.p_OnTable.isSet(E_Blocks.b5);
	...
	public boolean isStick(State state, T_Block block) {
		return !state.p_Movable.isSet(block) && (state.p_Holding.isSet(E_Slipperys.h1, block) || state.p_Holding.isSet(E_Slipperys.h2, block) || state.p_Holding.isSet(E_Stickys.h3, block));
	}
