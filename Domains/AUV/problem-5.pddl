...
(connected-ship s2 l-1-9 l-2-9)
(connected-ship s2 l-2-9 l-3-9)
(connected-ship s2 l-3-9 l-4-9)
(connected-ship s2 l-4-9 l-5-9)
(connected-ship s2 l-5-9 l-6-9)
(connected-ship s2 l-6-9 l-7-9)
(connected-ship s2 l-7-9 l-8-9)
(connected-ship s2 l-8-9 l-9-9)
(connected-ship s2 l-9-9 l-10-9)
(connected-ship s2 l-10-9 l-11-9)
(connected-ship s2 l-11-9 l-12-9)
(connected-ship s2 l-12-9 l-13-9)
(connected-ship s2 l-13-9 l-14-9)
(connected-ship s2 l-14-9 l-15-9)
(connected-ship s2 l-15-9 l-16-9)
