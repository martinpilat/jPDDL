...
(connected-ship s2 l-1-5 l-2-5)
(connected-ship s2 l-2-5 l-3-5)
(connected-ship s2 l-3-5 l-4-5)
(connected-ship s2 l-4-5 l-5-5)
(connected-ship s2 l-5-5 l-6-5)
(connected-ship s2 l-6-5 l-7-5)
(connected-ship s2 l-7-5 l-8-5)
